...
import { FaWhatsapp, FaEnvelope } from "react-icons/fa"; // Importing icons from react-icons

const NewsLatterBox = () => {
  return (
    <>
      <section
        className=" relative z-10 rounded-2xl bg-primary/[3%] mt-28 bg-[#f38a0b] p-8 dark:bg-primary/10 sm:p-11 lg:p-8 xl:p-11"

      >
        <Link
          href="/"
          className="header-logo block w-full lg:py-2 py-8"
        >
          <Image
            src="/public/logo.png"
            alt="logo"
            width={140}
            height={30}
            className=" text-center mx-auto mb-4 dark:hidden"
          />
          <Image
            src="/public/logo.png"
            alt="logo"
            width={140}
            height={30}
            className="hidden text-center mx-auto mb-4 dark:block"
          />
        </Link>

        {/* <h3 className="mb-4 text-2xl text-center font-bold leading-tight text-black dark:text-white ">
          Special Classes for Kids & Adults
          <p className="mb-4 border-b text-center border-body-color border-opacity-25 pb-4 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
            (Male & Female)
          </p>
        ...
        {/* DevSTRIM Section */}
        <h3 className="mb-4 text-xl text-center font-bold leading-tight text-black dark:text-white">
          Empowering Your Digital Presence
          <p className="mb-4 border-b text-center border-body-color border-opacity-25 pb-4 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
            Affordable & Luxurious Digital Solutions
          </p>
        </h3>
        ...
        <p className="mb-4 border-b text-center border-body-color border-opacity-25 pb-4 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
          Creative Branding & Content Development
        </p>
        <p className="mb-4 border-b text-center border-body-color border-opacity-25 pb-4 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
