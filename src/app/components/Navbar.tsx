...
// import logo from "../../../public/MSN-PRODUCTION-LOGO.png";
// import { ImCross } from "react-icons/im";
// import Drawer from "react-modern-drawer";
// import "react-modern-drawer/dist/index.css";
// import "../../app/components/Shared.css";
...
//     ];
//     const activeLink = ({ isActive }: { isActive: any }) => {
//         return {
//             fontWeight: 500,
...
import React, { useState, useEffect } from "react";
import { Link, NavLink } from "react-router-dom";
import { FaBars, FaHome, FaInfoCircle, FaBox, FaPhone, FaBlog } from "react-icons/fa";
import logo from "../../../public/MSN-PRODUCTION-LOGO.png";
import { ImCross } from "react-icons/im";
import Drawer from "react-modern-drawer";
import "react-modern-drawer/dist/index.css";
...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { title: "Tentang", link: "/tentang", icon: <FaInfoCircle /> },
        { title: "Paket", link: "/paket", icon: <FaBox /> },
        { title: "Kontak", link: "/kontak", icon: <FaPhone /> },
    ...
    return (
        <div
            className={`visible ${show && "nav-hidden"} shadow-lg bg-neutral z-50`}
        >
            <div className="flex items-center justify-between w-full px-3 py-3 md:px-24">
                <div>
                    <Link to="/">
                ...
                <div>
                    <ul className="items-center hidden lg:flex">
                        {navLinks.map((navItem) => (
                            <li className="mx-4 flex items-center" key={navItem.title}>
