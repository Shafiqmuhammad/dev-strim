...
export default function Privacy(): JSX.Element {
    return (
        <>
            <div className="mx-auto   text-justify bg-black" id="Privacy">

                <h2 className="text-center mb-3 text-3xl font-bold tracking-tight text-[#f38a0b] sm:text-5xl"><b>PRIVACY POLICY</b></h2>
                <p className="mb-3 text-lg  text-[#f38a0b]">
                    <p>Last updated: 2024-02-20</p>
                    <p><b>PRIVACY POLOICY</b></p>

                    <p>Effective date: 2025-02-20</p>
                    <p>1. <b>Introduction</b></p>
                    <p>Welcome to <b> Panaverse DAO</b>.</p>
                    <p><b>Panaverse DAO</b> (“us”, “we”, or “our”) operates <b>https://www.DevSTRIM.com</b> (hereinafter referred to as <b>“Service”</b>).</p>
                    <p>Our Privacy Policy governs your visit to <b>https://www.DevSTRIM.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                    ...
                    <p><b>SERVICE</b> means the https://www.DevSTRIM.com website operated by Panaverse DAO.</p>
                    ...
                    <p>Panaverse DAO uses the collected data for various purposes:</p>
                    ...
                    <p>Panaverse DAO will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                    ...
                    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>shafiq00786@hotmail.com</b>.</p>
                    ...
                    <p>0.4. users are able to change their personal information by emailing us at <b>shafiq00786@hotmail.com</b>.</p>
                    ...
                    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>shafiq00786@hotmail.com</b>.</p>
                    ...
                    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>shafiq00786@hotmail.com</b>.</p>
                    <p className="mt-3 text-sm">This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created for <b>https://www.DevSTRIM.com</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2024-02-20.</p>
