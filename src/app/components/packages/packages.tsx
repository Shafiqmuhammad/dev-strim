            ...
            <div className="flex flex-col px-6 py-20 md:px-32  ">
                ...
                <div className="text-orange-500">
                    <div className="flex flex-wrap items-center justify-center mt-2 mb-6">
                        ...
                        <button className="btn btn-sm text-2xl rounded-2xl bg-[#f38a0b]  border-2 border-[#f38a0b]  text-black font-bold hover:bg-transparent hover:border-[#f38a0b]  hover:text-[#f38a0b]  duration-300 mx-3 my-3 sm:my-0 active-btn">
                            AI Website </button>



                        <button className="btn btn-sm rounded-2xl text-2xl bg-[#f38a0b]  border-2 border-[#f38a0b]  text-black font-bold hover:bg-transparent hover:border-[#f38a0b]  hover:text-[#f38a0b]  duration-300 mx-3 my-3 sm:my-0 false">
                        ...
                        <button className="btn btn-sm text-2xl rounded-2xl bg-[#f38a0b]  border-2 border-[#f38a0b]  text-black font-bold hover:bg-transparent hover:border-[#f38a0b]  hover:text-[#f38a0b]  duration-300 mx-3 my-3 sm:my-0 false">
