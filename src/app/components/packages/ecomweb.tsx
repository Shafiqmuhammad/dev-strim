...
const Ecomweb = () => {
    ...
    return (
        <section id="ecomsection" className=" flex flex-col px-6 pt-2 pb-20 md:px-32 bg-black ">
            <h1 className="text-4xl lg:text-6xl text-center text-[#f38a0b] font-extrabold">Ecom
                <span className="text-white">Website</span> </h1>
